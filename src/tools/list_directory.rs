...
/// The focused-test sandbox contract of the list_directory builtin: available exactly for
...
/// Builds the focused-test standalone `list_directory` ToolSet from the same definition and
