...
- M14：继续执行并记录显式real-credential live smoke，随后实现production Tool/Sandbox adapters；Structured public activation、具体Prompt/Skill source、production ask-user builtin、Session-local mutation permit attachment、resource-level Tool policy/Sandbox与public Tool DTO继续pending。
