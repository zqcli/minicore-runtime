...
V1已归档，仅用于历史参考；V2是当前权威架构。第四轮评审的全部P0与P1-4已关闭，生产实现仍待启动；当前暂停点是联合关闭[第四轮设计评审](docs/review/v2-design-review-4.md)的V4-P1-1 Runtime public payload和V4-P1-2 wire/storage format v1，随后创建Rust crate并启动阶段6–8 async vertical slice。完整换机进度见[设计评审工作交接](docs/review/v2-design-review-handoff.md)。
