...
- M5.0/M5.1/M5.2 foundation：durable entity publication、exact historical definition resolution、Workspace resolver/Snapshot、loaded Ready+Idle publication owner、Runtime residency integration与tolerant semantic replay/corruption sidecars已完成；下一步实现public Runtime routing、replay/Recorder-backed full Load、active-Turn grace Unload、remaining Fork anchors/LiveSnapshot与完整platform matrix，并关闭M5.1完整fixture/native exit gate；
