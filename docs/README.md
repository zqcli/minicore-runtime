...
- M5.0/M7 foundation：durable entity publication、exact historical definition resolution、Workspace resolver/Snapshot、loaded Ready+Idle publication owner与Runtime residency/lifecycle integration已完成；下一步实现public Runtime routing、replay/Recorder-backed full Load、active-Turn grace Unload、remaining Fork anchors/LiveSnapshot与完整platform matrix；
