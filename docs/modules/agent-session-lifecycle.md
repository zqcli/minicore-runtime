...
状态：当前权威架构（ADR 0136/0137；M5.0 recovery/root lease/owner-tracked actor、private reservation foundation、crate-private Agent Create与ordinary Session Create exact G1 publication，以及unloaded RecordedHistory + Genesis Session Fork tracer已实现；public Runtime command接入、remaining Fork anchors/LiveSnapshot、update/CAS、完整cross-platform native matrix、Recorder/replay pending）
日期：2026-07-31
