...
- `session::actor` owns durable append authority and terminal settlement; it consumes the conversation-owned durability classification without moving transcript operation policy into the shared seam.
