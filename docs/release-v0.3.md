...
- 290 root library tests plus passing cleaned integration/provider-gate suites;
...
| --- | ---: | ---: | ---: |
| cfg(test)-excluded production LOC | 15,483 | 14,134 | -1,349 |
| raw `src/**/*.rs` lines | 48,055 | 31,426 | -16,629 |
