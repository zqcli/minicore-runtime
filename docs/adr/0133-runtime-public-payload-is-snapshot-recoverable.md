...
状态：Partially Superseded by ADRs 0135 and 0136
日期：2026-07-31

> 2026-08-03 refinement: ADR 0136 specifies the sole integrity-fatal post-admission dispatch result (`RuntimeDispatchError::InternalDispatchUnavailable`), publication certainty, and the required completion-before-Closing ordering. No wire shape is added. The historical decision body below is unchanged.
>
