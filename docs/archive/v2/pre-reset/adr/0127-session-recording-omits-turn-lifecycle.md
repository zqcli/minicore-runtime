...
> 2026-07-31：[ADR 0131](0131-conversation-recording-excludes-session-definition-and-lifecycle.md)进一步删除SessionDefinitionChanged/SessionLifecycleChanged；JSONL只保存messages、Interaction和Compaction，Agent/Session current state由各自durable owner保存。
