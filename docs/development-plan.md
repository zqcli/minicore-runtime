...
- [x] Added canonical `scripts/acceptance_v03.json` and generated `docs/acceptance-v0.3.md` with one Passed row and one-or-more attributed evidence entries for every AT-K criterion (AT-K01 through AT-K85).
