...
- [x] real-credential release evidence（[ADR 0145](adr/0145-live-provider-evidence-refines-direct-adapter-wire-truth.md)）：2026-08-12连续运行OpenAI Responses与Anthropic Messages两个exact ignored public Runtime smoke，均成功；credential仅经仓库外0600临时环境文件注入并在运行后unset/delete，文档不记录credential、private endpoint或response content；
