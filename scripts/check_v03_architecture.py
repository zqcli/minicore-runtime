...
REQUIRED_FILES = {
    ...
    "src/conversation/mod.rs", "src/conversation/entry.rs", "src/conversation/state.rs",
    "src/conversation/validator.rs", "src/conversation/projection.rs", "src/conversation/log.rs",
    "src/conversation/recovery.rs", "src/model/mod.rs", "src/model/model.rs", "src/model/types.rs",
